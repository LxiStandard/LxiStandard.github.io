...
The following document describes the LXI Consortium policies for certifying conformance to the current LXI 1.6 and previous versions:</p>
  <ul>
    <li><a href="../assets/conformance/LXI Conformance Policy for Certifying Conformance to LXI Consortium Standards V1.6 Rev2.4.pdf"><strong>LXI Consortium Policy for Certifying to LXI Consortium Standards</strong></a></li>
  </ul>
