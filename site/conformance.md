...
The following document describes the LXI Consortium policies for certifying conformance to the current LXI 1.6 and previous versions:</p>
  <ul>
    <li><a href="../assets/conformance/LXI Conformance Policy for Certifying Conformance to LXI Consortium Standards V1.6 Rev2.4.docx"><strong>LXI Consortium Policy for Certifying to LXI Consortium Standards</strong></a></li>
  </ul>
...
<style type="text/css">
  ...
  <!--<ul>
    <li>LXI Conformance Test Suite</li>
    <li>TSEP Kerberos Test Suite</li>
  </ul>
  <p>The LXI Conformance Test Suite is the original test suite that has been updated as the LXI specification has evolved over the years. Once you are a member you can download the LXI Conformance Test Suite, which is available on the website in the in the Secure Download area. (A consortium member obtains the secure download logon and password from <a href="mailto:execdir@lxistandard.org"><strong>Aaron Hall</strong></a>).</p>
  <ul>
    <li><a href="http://lxistandard.org/secure-downloads/SecureDownloads.aspx"><strong>LXI Conformance Test Suite</strong></a></li>
  </ul>
  <p>This software is an automated test bench maintained by the LXI Consortium, which covers all the mandatory rules specified in the LXI Standard.<br>-->
    <br>
    ...
    Either one of the Conformance Test Suites can be used by vendors for any in-house pre-certification testing for those who would like to see how their products are doing with the LXI conformance process. It should be treated as a pre-test before submitting the product for compliance testing. <br><br>
...
<ul type="disc">
  ...
  If your device has successfully passed the LXI conformance tests submit your “Application for Certification to LXI Device Specification 2016” with your conformance documentation together with the test results (LXI Conformance Test Suite XML/PDF file) to <a href="mailto:thwg@members.lxistandard.org">the LXI Conformance Committee</a>. For the conformance documentation use the 2-page template form:</p>
  <ul>
  ...
  <p>After successfully completed, the LXI Conformance Tests with the new (similar) product submit the following documents via email to <a href="mailto:thwg@members.lxistandard.org">the LXI Conformance Committee</a>:</p>
  <ul>
